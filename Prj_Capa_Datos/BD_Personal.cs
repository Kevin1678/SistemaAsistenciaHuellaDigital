  ...
  public class BD_Personal : Cls_Conexion 
    {
        ...
        public void BD_Registrar_Huella_Personal(string idper, object finguer, string fingermask)
        {
            SqlConnection cn = new SqlConnection(Conectar());
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@FingerMask", fingermask);
                cn.Open();
                cmd.ExecuteNonQuery();
                cn.Close();
        ...
        public void BD_Eliminar_Huella_Personal(string idper, string fingermask)
        {
            SqlConnection cn = new SqlConnection(Conectar());
            SqlCommand cmd = new SqlCommand("Sp_Delete_FinguerPrint", cn);
            try
            {
                cmd.CommandTimeout = 20;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@Id_Person", idper);
                cmd.Parameters.AddWithValue("@FingerMask", fingermask);
                cn.Open();
                cmd.ExecuteNonQuery();
                cn.Close();
