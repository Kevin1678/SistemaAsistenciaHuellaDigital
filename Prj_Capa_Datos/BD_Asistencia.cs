...
namespace Prj_Capa_Datos
{
    public class BD_Asistencia : Cls_Conexion
    {
        ...
        //Imprimir por persona asistencia por fecha
        public DataTable BD_Ver_Asistencia_porPersona_Fechas(string IdAsis, DateTime xfechaini, DateTime xfechafin)
        {
            SqlConnection xcn = new SqlConnection();
            try
            {
                xcn.ConnectionString = Conectar();
                SqlDataAdapter da = new SqlDataAdapter("Sp_Buscar_Asistencia_xPersona_Fechas", xcn);
                da.SelectCommand.CommandType = CommandType.StoredProcedure;
                da.SelectCommand.Parameters.AddWithValue("@Id_Asis", IdAsis);
                da.SelectCommand.Parameters.AddWithValue("@FechaIni", xfechaini);
                da.SelectCommand.Parameters.AddWithValue("@FechaFin", xfechafin);
                DataTable Dato = new DataTable();
                da.Fill(Dato);
                da = null;
                return Dato;
        ...
        //salida
        public void BD_Registrar_Salida_Personal(string idAsis, string idPerso, string HoSalida, double totalHora, double adelanto)
        {
