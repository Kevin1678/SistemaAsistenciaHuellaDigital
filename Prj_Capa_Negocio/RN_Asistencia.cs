...
namespace Prj_Capa_Negocio
{
    public class RN_Asistencia
    {
        ...
        public void RN_Registrar_Salida_Personal(string idAsis, string idPerso, string HoSalida, double totalHora, double adelanto)
        {
            BD_Asistencia obj = new BD_Asistencia();
            obj.BD_Registrar_Salida_Personal(idAsis, idPerso, HoSalida, totalHora,adelanto);
        }
        ...
        //rn impresion por fechas
        public DataTable RN_Ver_Asistencia_porPersona_Fechas(string IdAsis, DateTime xfechaini, DateTime xfechafin)
        {
            BD_Asistencia obj = new BD_Asistencia();
            return obj.BD_Ver_Asistencia_porPersona_Fechas(IdAsis, xfechaini, xfechafin);
        }
