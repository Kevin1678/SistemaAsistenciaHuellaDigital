...
namespace MicroSisPlani.Personal
{
    public partial class Frm_Registro_Personal : Form
    {
        ...
        private bool ValidarCajasTexto()
        {
            ...
            if (txt_NroCelular.Text.Trim().Length == 11) { fil.Show(); adv.Lbl_Msm1.Text = "El Nro de Celular debe tener 10 caracteres"; adv.ShowDialog(); fil.Hide(); txt_NroCelular.Focus(); return false; }
            if (txt_NroCelular.Text.Trim().Length == 11) { fil.Show(); adv.Lbl_Msm1.Text = "Ingrese el Nro de Celular del Personal"; adv.ShowDialog(); fil.Hide(); txt_NroCelular.Focus(); return false; }
        ...
        private void Guardar_Personal()
        {
            ...
            try
            {
                ...
                per.Celular = txt_NroCelular.Text;
                ...
                {
                    fil.Show();
                    ok.Lbl_msm1.Text = "Los Datos del Personal se han Registrado Correctamente, No Olvide Registrar su Contrato y Huella de este Personal";
                    ok.ShowDialog();
                    fil.Hide();
