...
namespace MicroSisPlani
{
    public partial class Frm_Marcar_Asis_Manual : Form
    {
        ...
        private void btn_buscar_Click(object sender, EventArgs e)
        {
            ...
            RN_Contrato contrato = new RN_Contrato();
            DataTable dataContrato = new DataTable();
            ...
            try
            {
                ...
                else
                {
                    ...
                    {                      
                        ...
                        //Buscar Sueldo
                        dataContrato = contrato.RN_Buscar_Contrato(Lbl_Idperso.Text);
                        ...
                        lbl_TotalHotrabajda.Text = Convert.ToString(dataAsis.Rows[0]["Total_HrsWorked"]);
                                             
                        labelpagoHora.Text = Convert.ToString(dataContrato.Rows[0]["Sueldo_Fijo"]);
                        ...
                        //calcular hora trabajada por plata ejemplo trabajo 8 * 13 bs total a pagar 104Bs dia por 5dias 520 semnal 520*4semans mensual 2080bs
                       
                       objas.RN_Registrar_Salida_Personal(lbl_IdAsis.Text, Lbl_Idperso.Text, lbl_hora.Text,Convert.ToDouble(lbl_TotalHotrabajda.Text), Convert.ToDouble(labelTotalPago.Text));
        ...
        void calcular_Minutos_Tardanza()
        {
            ...
            { // si esta aprobada la justificacion no registra los minutos de tardanza
